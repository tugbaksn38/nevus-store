// src/app/nevus/dekorasyon/page.js
...
export default function DekorasyonPage() {
  ...
  useEffect(() => {
    const fetchProducts = async () => {
      try {
        setLoading(true);
        const response = await fetch("/api/nevus/dekorasyon");
    ...
    >
      ...
      <div className="p-6 max-w-7xl mx-auto">
        <div className="flex justify-between items-center mb-8">
          <h1 className="text-3xl font-bold text-gray-800 dark:text-white">Dekorasyon Ürünleri</h1>
          {!loading && !error && (
...
<AnimatedButton 
  href={`/nevus/dekorasyon/${product.id}`} // ID'ye göre link
