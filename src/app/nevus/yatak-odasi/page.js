// src/app/nevus/yatak-odasi/page.js
// src/app/nevus/yatak-odasi/page.js
...
export default function YatakPage() {
  ...
  useEffect(() => {
    const fetchProducts = async () => {
      try {
        setLoading(true);
        const response = await fetch("/api/nevus/yatak-odasi");
    ...
    >
      ...
      <div className="p-6 max-w-7xl mx-auto">
        <div className="flex justify-between items-center mb-8">
          <h1 className="text-3xl font-bold text-gray-800 dark:text-white">Yatak Odası Ürünleri</h1>
          {!loading && !error && (
...
<AnimatedButton 
  href={`/nevus/yatak-odasi/${product.id}`} // ID'ye göre link
